class Host::ListingsController < ApplicationController
    ...
    private
      ...
      def listing_create_params
        params.require(:listing).permit(:title, :about, :max_guests, :address_line_1, :address_line_2, :city, :state, :postal_code, :country, :status, :listing_type, :size, :furniture, facility_ids: [], amenity_ids: [], suitability_ids: [], listing_photos_attributes: [:id, :_destroy, :caption, :photo])
      end

      def listing_update_params
        params.require(:listing).permit(:title, :about, :max_guests, :city, :state, :postal_code, :country, :status, :listing_type, :size, :furniture, facility_ids: [], amenity_ids: [], suitability_ids: [], listing_photos_attributes: [:id, :_destroy, :caption, :photo])
      end
